  ...
  // === Slider "Avant/Après" ===
        ...
        // إيقاف التنقل التلقائي عند التمرير فوق السلايدر
        document.querySelector('.carousell').addEventListener('mouseenter', stopAutoSlide);
        document.querySelector('.carousell').addEventListener('mouseleave', startAutoSlide);
